class Koboldcpp < Formula
  ...
  if OS.linux? && Hardware::CPU.intel?
    url "https://github.com/LostRuins/koboldcpp/releases/download/v1.94.1/koboldcpp-linux-x64"
    sha256 "9d218d64f7329be4c9f05f9cd3704aaf69b6db5ffbdd1da822e13999a719d170"
  else
