class Koboldcpp < Formula
  ...
  if OS.linux? && Hardware::CPU.intel?
    url "https://github.com/LostRuins/koboldcpp/releases/download/v1.105.2/koboldcpp-linux-x64"
    sha256 "319749ecb2b5f6a33e44fc8f686c231804e33c3091eac82d5eaa67d7d692bddb"
  else
