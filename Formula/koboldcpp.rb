class Koboldcpp < Formula
  ...
  if OS.linux? && Hardware::CPU.intel?
    url "https://github.com/LostRuins/koboldcpp/releases/download/v1.94.2/koboldcpp-linux-x64"
    sha256 "0544992ce1067cdd034749130abc12ee354de62cc30ea722a8a2ecf635381afd"
  else
