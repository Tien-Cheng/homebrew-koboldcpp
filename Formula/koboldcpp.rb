class Koboldcpp < Formula
  ...
  if OS.linux? && Hardware::CPU.intel?
    url "https://github.com/LostRuins/koboldcpp/releases/download/v1.101.1/koboldcpp-linux-x64"
    sha256 "8596481a5edf2ab65d9a07ac1f550ace1b2d5e795ddd82a83cc731020f45a8bf"
  else
