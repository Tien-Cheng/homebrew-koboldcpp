class Koboldcpp < Formula
  ...
  if OS.linux? && Hardware::CPU.intel?
    url "https://github.com/LostRuins/koboldcpp/releases/download/v1.93.1/koboldcpp-linux-x64"
    sha256 "e5d3c3d36ba957af150429231df75108ecacac39133992f2f7af639cce0cec99"
  else
