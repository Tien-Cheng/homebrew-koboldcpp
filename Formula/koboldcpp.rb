class Koboldcpp < Formula
  ...
  if OS.linux? && Hardware::CPU.intel?
    url "https://github.com/LostRuins/koboldcpp/releases/download/v1.107.1/koboldcpp-linux-x64"
    sha256 "a410d31d8fedb971d9504097454992640faa5d8854bfda89dd29b21738271f01"
  else
