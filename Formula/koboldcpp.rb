class Koboldcpp < Formula
  ...
  if OS.linux? && Hardware::CPU.intel?
    url "https://github.com/LostRuins/koboldcpp/releases/download/v1.104/koboldcpp-linux-x64"
    sha256 "8bbf6840013a59d35ec9702201aaf7697c38f3a38ffe7f3b4caec0cf5a7af51c"
  else
