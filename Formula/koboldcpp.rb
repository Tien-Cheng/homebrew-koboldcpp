class Koboldcpp < Formula
  ...
  if OS.linux? && Hardware::CPU.intel?
    url "https://github.com/LostRuins/koboldcpp/releases/download/v1.107.3/koboldcpp-linux-x64"
    sha256 "b024b6a0d67476f7e3aa53b862577d016615ade9c63ea79ede0f9a8ff0bb8523"
  else
